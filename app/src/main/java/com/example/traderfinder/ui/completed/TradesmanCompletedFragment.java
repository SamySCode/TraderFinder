...
public class TradesmanCompletedFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_tradesman_completed, container, false);

        completedRecyclerView = view.findViewById(R.id.tradesman_completed_jobs_recyclerview);
        completedRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        completedJobs = new ArrayList<>();
        jobAdapter = new JobAdapter(getContext(), new ArrayList<>(), "tradesman"); // Or "tradesman", depending on the type of account
